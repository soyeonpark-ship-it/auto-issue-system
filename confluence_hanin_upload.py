...
# -*- coding: utf-8 -*-
"""
Confluence Wiki 생성 - 한인민박 파트너 검수
"""
...
TARGET_PAGE_ID = "1194033239"  # CD space
...
<ul>
<li><strong>원본 페이지</strong>: <a href="https://mrtcx.atlassian.net/wiki/spaces/aoh/pages/1100316692">한인민박 파트너 검수</a></li>
<li><strong>파트너 검수 가이드라인</strong>: <a href="https://docs.google.com/spreadsheets/d/1NuT98a8fFif-OgzzAesJ0jNC-Z4JtCOQu51589quKIA/edit?gid=467620599#gid=467620599">구글 시트</a></li>
</ul>

<hr />

<h2>📊 한인민박 파트너 검수 프로세스 플로우차트</h2>
...
def main():
    print("=" * 60)
    print("Confluence Wiki 생성 - 한인민박 파트너 검수")
    print("=" * 60)
    ...
    try:
        image_path = "mermaid_images/hanin_partner_inspection.png"
