...
# -*- coding: utf-8 -*-
"""
Confluence Wiki 생성 - 해외 연동 신규 상품 등록 (2.0)
"""
...
TARGET_PAGE_ID = "1176109101"  # CD space
...
<h2>해외 연동 신규 상품 등록 (2.0) 프로세스 플로우차트</h2>
...
def main():
    print("=" * 60)
    print("Confluence Wiki 생성 - 해외 연동 신규 상품 등록 (2.0)")
    print("=" * 60)
    ...
    try:
        image_path = "mermaid_images/overseas_product_register_2.0.png"
