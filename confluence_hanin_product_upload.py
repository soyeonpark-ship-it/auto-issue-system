...
TARGET_PAGE_ID = "1193803904"  # CD space
...
<ul>
<li><strong>원본 페이지</strong>: <a href="https://mrtcx.atlassian.net/wiki/spaces/aoh/pages/1050378392">한인민박 상품 등록</a></li>
</ul>

<hr />

<h2>📊 한인민박 상품 등록 프로세스 플로우차트</h2>
...
def main():
    print("=" * 60)
    print("Confluence Wiki 생성 - 한인민박 상품 등록")
    print("=" * 60)
    ...
    try:
        image_path = "mermaid_images/hanin_product_register.png"
