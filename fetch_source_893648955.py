...
def main():
    ...
    try:
        ...
        # 내용을 JSON 파일로 저장
        with open('confluence_source_893648955.json', 'w', encoding='utf-8') as f:
            json.dump(page, f, ensure_ascii=False, indent=2)
        
        # HTML 내용을 별도 파일로 저장
        with open('confluence_source_893648955.html', 'w', encoding='utf-8') as f:
            f.write(page['body']['storage']['value'])
        
        print("✓ confluence_source_893648955.json 저장 완료")
        print("✓ confluence_source_893648955.html 저장 완료")
