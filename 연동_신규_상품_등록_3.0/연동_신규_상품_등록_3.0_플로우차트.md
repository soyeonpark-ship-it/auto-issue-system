...
- **3.0 이관 공급사** (2025-12-09 기준): KKDAY, 몽키트래블_태국 & 베트남
- **공급사 상품 페이지**: Sanctum에서 바로 진입 가능

## 주요 단계 요약

### 1단계: 매니저 접근
- T&A 연동 상품 메뉴에서 공급사 선택
...
### 7단계: 공급사별 처리
- **KKDAY**: 대표가 등록 필요 → 슬랙 노티
- **KLOOK**: 판매가 정책 없이 바로 진행
- **기타**: 일반 심사 요청
